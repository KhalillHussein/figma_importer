...
abstract class _$ArcDataCWProxy {
  ...
  /// This function **does support** nullification of nullable fields.
  /// All `null` values passed to `non-nullable` fields will be ignored.
  /// You can also use `ArcData(...).copyWith.fieldName(...)` to override
  /// fields one at a time with nullification support.
  ///
  /// Usage
  /// ```dart
...
///  be used as follows: `instanceOfArcData.copyWith(...)`. Additionally
/// contains functions for specific fields e.g.
///  `instanceOfArcData.copyWith.fieldName(...)`
...
extension $ArcDataCopyWith on ArcData {
  ...
  ///  `instanceOfArcData.copyWith(...)` or like
  /// so:`instanceOfArcData.copyWith.fieldName(...)`.
