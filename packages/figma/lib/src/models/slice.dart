...
/// A slice is a special kind of node that represents a section of the canvas
/// that can be exported. Slices do not clip their children, and can contain
/// children that are outside of their bounds.
///
