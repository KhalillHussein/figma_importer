...
abstract class _$SectionCWProxy {
  ...
  Section rotation(double? rotation);

  Section pluginData(dynamic pluginData);
  ...
  Section individualStrokeWeights(StrokeWeights? individualStrokeWeights);
...
class _$SectionCWProxyImpl implements _$SectionCWProxy {
  ...
  @override
  Section rotation(double? rotation) => this(rotation: rotation);

  @override
  Section pluginData(dynamic pluginData) => this(pluginData: pluginData);
